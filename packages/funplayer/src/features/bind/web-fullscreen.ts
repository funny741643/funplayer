...
const classWebFull = "web_fullscreen";
...
export class WebFullscreen implements Dispose {
    ...
    get isActive(): boolean {
        return containClass(this.player.el, classWebFull);
    }

    enter(): void {
        addClass(this.player.el, classWebFull);
    ...
    exit(): boolean {
        ...
        removeClass(this.player.el, classWebFull);
